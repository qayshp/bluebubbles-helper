...
// Called when plugin is inserted into Find My
+ (void)load {
    ...
    if ([[[NSBundle mainBundle] bundleIdentifier] isEqualToString:@"com.apple.findmy"]) {
...
//            [convo sendMessage:message newComposition:YES];
        ...
        os_log_error(logger,  "Injected into non-Find My process %@, aborting.", [[NSBundle mainBundle] bundleIdentifier]);
        return;
    }
}
